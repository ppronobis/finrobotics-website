            ...
            >
              ...
              <div className="prose prose-slate max-w-none">
                ...
                <p className="text-muted-foreground mb-4">
                  (1) Diese Nutzungsbedingungen (nachfolgend „AGB") gelten für sämtliche Verträge zwischen FinRobotics, vertreten durch Prof. Dr. Paul Pronobis (nachfolgend „Anbieter"), und der jeweiligen Steuerberatungskanzlei (nachfolgend „Kunde") über die Nutzung der FinRobotics-Plattform und deren KI-Agenten.
                </p>
                <p className="text-muted-foreground mb-4">
                  (2) Diese AGB richten sich ausschließlich an Unternehmer im Sinne des § 14 BGB, insbesondere Steuerberatungskanzleien und deren Inhaber. FinRobotics bietet keine Leistungen für Verbraucher an.
                </p>
                <p className="text-muted-foreground mb-4">
                ...
                <p className="text-muted-foreground mb-4">
                  (1) Der Anbieter stellt dem Kunden KI-gestützte Agenten als Software-as-a-Service (SaaS) zur Verfügung. Die Agenten unterstützen die Steuerberatungskanzlei bei folgenden Aufgaben:
                </p>
                ...
                <p className="text-muted-foreground mb-4">
                  (2) Die Plattform dient ausschließlich der Unterstützung bei der Buchhaltung und ersetzt keine steuerliche, rechtliche oder wirtschaftliche Beratung. Die Verantwortung für die korrekte steuerliche Bearbeitung verbleibt beim Kunden.
                </p>
                <p className="text-muted-foreground mb-4">
                ...
                <p className="text-muted-foreground mb-4">
                  (1) Der Vertrag kommt zwischen dem Anbieter und der Steuerberatungskanzlei (B2B) zustande. Der Kunde garantiert, dass er zum Vertragsschluss berechtigt ist und im Namen der Kanzlei handelt.
                </p>
                <p className="text-muted-foreground mb-4">
                ...
                <p className="text-muted-foreground mb-4">
                  (2) Ausschließlicher Gerichtsstand für alle Streitigkeiten aus oder im Zusammenhang mit diesem Vertrag ist Karlsruhe, soweit gesetzlich zulässig.
                </p>
                <p className="text-muted-foreground mb-4">
